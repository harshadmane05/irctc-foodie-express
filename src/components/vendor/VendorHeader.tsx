      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <Link to="/vendor" className="flex items-center">
            <div className="bg-gradient-premium p-1.5 rounded-lg mr-2">
        ...
        <div className="hidden md:flex items-center space-x-1">
          <Link 
            ...
            className={`px-3 py-2 rounded-md flex items-center space-x-2 ${
              isActive('/vendor') 
                ? 'bg-orange-50 text-irctc-orange gold-border' 
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <Button variant="ghost" size="icon" className="rounded-full text-gray-600 hover:bg-orange-50">
              <Bell size={18} />
              <span className="absolute -top-0.5 -right-0.5 bg-irctc-red text-white text-xs w-4 h-4 flex items-center justify-center rounded-full">
                3
              </span>
            </Button>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-3">
            <div className="bg-gradient-to-r from-orange-100 to-orange-50 px-3 py-1.5 rounded-lg">
